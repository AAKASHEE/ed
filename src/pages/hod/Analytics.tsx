...
// Mock data - same as in TeacherAnalytics.tsx but kept here for modularity
const mockAnalytics = {
  '2022-2026': {
    classAverage: 7.8,
    highestScore: 9.5,
    ...
    facultyPerformance: {
      'Dr. Jane Teacher': 4.7,
      'Prof. Robert Johnson': 4.8,
      'Dr. Michael Davis': 4.5,
      'Prof. Emily Wilson': 4.9,
    },
  },
  '2023-2027': {
    classAverage: 8.1,
    ...
    facultyPerformance: {
      'Dr. Jane Teacher': 4.8,
      'Prof. Robert Johnson': 4.9,
      'Dr. Michael Davis': 4.6,
      'Prof. Emily Wilson': 4.7,
    },
  },
};
...
const HodAnalytics = () => {
  ...
  const [analysisType, setAnalysisType] = useState<'class' | 'student' | 'department'>('class');
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {selectedBatch && analysisType === 'class' && batchData && (
        <div className="space-y-6">
          ...
          <div className="card">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Batch Performance Analysis</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-indigo-50 rounded-lg">
                <h3 className="font-semibold text-indigo-700 mb-2">Strengths</h3>
                <p>Strong performance in Machine Learning across the batch, with consistent improvement across all three CIEs.</p>
              </div>
              <div className="p-4 bg-orange-50 rounded-lg">
                <h3 className="font-semibold text-orange-700 mb-2">Areas for Department Focus</h3>
                <p>Database Systems shows consistently lower scores across the department. Additional resources may be needed.</p>
              </div>
              <div className="p-4 bg-green-50 rounded-lg">
                <h3 className="font-semibold text-green-700 mb-2">Recommendations</h3>
                <p>Consider curriculum review for Database Systems. Schedule department meeting to discuss teaching methodologies for challenging subjects.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {analysisType === 'department' && selectedBatch && batchData && (
        <div className="space-y-6">
          <div className="card">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Department Comparison</h2>
            <BarChart
              title={`CGPA Comparison Across Departments (${selectedBatch})`}
              labels={Object.keys(batchData.departmentComparison)}
              datasets={[
                {
                  label: 'Average CGPA',
                  data: Object.values(batchData.departmentComparison),
                  backgroundColor: [
                    'rgba(79, 70, 229, 0.7)',
                    'rgba(16, 185, 129, 0.7)',
                    'rgba(249, 115, 22, 0.7)',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="card">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Faculty Performance Rating</h2>
              <BarChart
                title="Student Feedback Ratings (out of 5)"
                labels={Object.keys(batchData.facultyPerformance)}
                datasets={[
                  {
                    label: 'Rating',
                    data: Object.values(batchData.facultyPerformance),
            ...
            <div className="card">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Department Insights</h2>
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h3 className="font-semibold text-blue-700 mb-2">Performance Overview</h3>
                  <p>AIML department is maintaining consistent academic standards with an average CGPA of {batchData.departmentComparison['AIML']}.</p>
                </div>
                
                <div className="p-4 bg-green-50 rounded-lg">
                  <h3 className="font-semibold text-green-700 mb-2">Faculty Excellence</h3>
                  <p>Prof. Emily Wilson has the highest student feedback rating at {batchData.facultyPerformance['Prof. Emily Wilson']} out of 5, recognized for innovative teaching methods.</p>
                </div>
                
                <div className="p-4 bg-purple-50 rounded-lg">
                  <h3 className="font-semibold text-purple-700 mb-2">Improvement Areas</h3>
                  <p>Consider professional development workshops for faculty with ratings below 4.7 to enhance teaching effectiveness.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Strategic Department Recommendations</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-indigo-50 rounded-lg">
                <h3 className="font-semibold text-indigo-700 mb-2">Curriculum Development</h3>
                <p>Review and update Database Systems curriculum based on consistent student performance data and industry demands.</p>
              </div>
              <div className="p-4 bg-orange-50 rounded-lg">
                <h3 className="font-semibold text-orange-700 mb-2">Faculty Support</h3>
                <p>Implement peer mentoring program pairing higher-rated faculty with those seeking improvement in specific teaching areas.</p>
              </div>
              <div className="p-4 bg-green-50 rounded-lg">
                <h3 className="font-semibold text-green-700 mb-2">Student Success</h3>
                <p>Develop early intervention program for students showing declining performance across multiple CIEs to improve retention and success rates.</p>
              </div>
            </div>
          </div>
        </div>
