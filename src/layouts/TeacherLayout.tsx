...
import { 
  GraduationCap, Home, Users, Upload, BarChart2, 
  LogOut, Menu, X 
} from 'lucide-react';
...
const TeacherLayout = () => {
  ...
  const navLinks = [
    ...
    { name: 'Upload Marks', path: '/teacher/marks', icon: <Upload size={20} /> },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-center text-gray-500">Teacher Portal</p>
        </div>
