...
import { 
  GraduationCap, Search, Users, BarChart2, 
  LogOut, Menu, X 
} from 'lucide-react';
...
const HodLayout = () => {
  ...
  const navLinks = [
    { name: 'Dashboard', path: '/hod/dashboard', icon: <Search size={20} /> },
    { name: 'Students', path: '/hod/students', icon: <Users size={20} /> },
    { name: 'Analytics', path: '/hod/analytics', icon: <BarChart2 size={20} /> },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-center text-gray-500">HOD Portal</p>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          {user && (
            <div className="flex items-center mb-4">
              <div className="bg-purple-100 rounded-full w-10 h-10 flex items-center justify-center text-purple-600 font-bold">
                {user.name.charAt(0)}
              </div>
              <div className="ml-3">
